...
# %%
dataset_name = 'york'
normal_data_file = f"./data/{dataset_name}/{dataset_name}_gt_abnormal.csv"
normal_data = np.genfromtxt(normal_data_file, delimiter=',')

# %%
normal_data = np.repeat(normal_data, 10, axis=0)
...
# %%
np.savetxt(f"./data/{dataset_name}/{dataset_name}_gt_abnormal.csv", normal_data, delimiter=',')
